...
const COLOR_PALETTE = {primary: "#76c893",secondary: "#b5e48c",background: "#f8f9fa",card: "#ffffff",text: "#343a40",subtleText: "#6c757d",accent: "#d9ed92"};
...
export default function MindfulnessPage() {
  ...
  return (
    <ScrollView style={styles.scrollView} contentContainerStyle={styles.container}>
      <Stack.Screen options={{ title: 'Mindfulness', headerStyle: { backgroundColor: COLOR_PALETTE.background }, headerTintColor: COLOR_PALETTE.text }} />
      ...
      <View style={styles.card}>
        ...
        <TextInput style={styles.journalInput} multiline placeholder="Reflect on your day..." placeholderTextColor="#999" value={journalText} onChangeText={setJournalText} />
      ...
      <View style={styles.card}>
        ...
        <TextInput style={styles.input} placeholder="e.g., Morning Meditation" value={reminderTitle} onChangeText={setReminderTitle} />
...
const styles = StyleSheet.create({
  scrollView: {backgroundColor: COLOR_PALETTE.background,},container: {padding: 20,paddingBottom: 40,},header: {fontSize: 32,fontWeight: 'bold',color: COLOR_PALETTE.text,textAlign: "center",},subHeader: {fontSize: 18,fontStyle: 'italic',color: COLOR_PALETTE.subtleText,textAlign: "center",marginBottom: 30,},card: {backgroundColor: COLOR_PALETTE.card,borderRadius: 20,padding: 20,marginBottom: 25,shadowColor: "#000",shadowOffset: { width: 0, height: 2 },shadowOpacity: 0.05,shadowRadius: 8,elevation: 3,},cardTitle: {fontSize: 22,fontWeight: '600',color: COLOR_PALETTE.text,marginBottom: 20,textAlign: "center",},breathCircle: {width: 200,height: 200,borderRadius: 100,justifyContent: "center",alignItems: "center",alignSelf: "center",marginBottom: 20,backgroundColor: COLOR_PALETTE.secondary,shadowColor: COLOR_PALETTE.primary,shadowOffset: { width: 0, height: 0 },shadowOpacity: 0.3,shadowRadius: 15,},lottie: {width: 250,height: 250,},tapToBeginText: {position: 'absolute',fontSize: 16,fontWeight: '500',color: COLOR_PALETTE.text,},breathingInfo: {alignItems: 'center',},breathText: {fontSize: 26,color: COLOR_PALETTE.text,fontWeight: "bold",marginBottom: 5,},durationText: {fontSize: 18,color: COLOR_PALETTE.subtleText,},promptText: {fontSize: 16,color: COLOR_PALETTE.text,textAlign: 'center',lineHeight: 24,marginBottom: 20,},promptButton: {backgroundColor: COLOR_PALETTE.accent,paddingVertical: 12,paddingHorizontal: 25,borderRadius: 25,alignSelf: 'center',},promptButtonText: {color: COLOR_PALETTE.text,fontWeight: '600',fontSize: 14,},moodContainer: {flexDirection: "row",justifyContent: "space-around",marginBottom: 15,},moodButton: {alignItems: 'center',padding: 10,borderRadius: 20,width: 70,height: 70,justifyContent: 'center',borderWidth: 2,borderColor: 'transparent',},moodSelected: {backgroundColor: `${COLOR_PALETTE.secondary}40`,borderColor: COLOR_PALETTE.secondary,transform: [{ scale: 1.1 }],},moodText: {fontSize: 28,},moodLabel: {fontSize: 12,color: COLOR_PALETTE.subtleText,marginTop: 4,},selectedMoodText: {fontSize: 16,textAlign: "center",color: COLOR_PALETTE.subtleText,fontStyle: 'italic',marginTop: 10,},journalInput: {height: 120,backgroundColor: COLOR_PALETTE.background,borderRadius: 15,padding: 15,fontSize: 16,color: COLOR_PALETTE.text,textAlignVertical: "top",lineHeight: 22,marginBottom: 15,borderWidth: 1,borderColor: '#e9ecef'},saveButton: {backgroundColor: COLOR_PALETTE.primary,paddingVertical: 15,borderRadius: 15,alignItems: "center",},saveButtonText: {color: "white",fontSize: 16,fontWeight: "bold",},meditationItem: {flexDirection: 'row',justifyContent: 'space-between',alignItems: 'center',paddingVertical: 15,borderBottomWidth: 1,borderBottomColor: COLOR_PALETTE.background,},meditationTitle: {fontSize: 16,fontWeight: '500',color: COLOR_PALETTE.text,},meditationDuration: {fontSize: 14,color: COLOR_PALETTE.subtleText,marginTop: 4,},playIcon: {fontSize: 24,color: COLOR_PALETTE.primary,width: 25,textAlign: 'center',},statsContainer: {flexDirection: 'row',justifyContent: 'space-around',},statItem: {alignItems: 'center',},statValue: {fontSize: 24,fontWeight: 'bold',color: COLOR_PALETTE.primary,},statLabel: {fontSize: 14,color: COLOR_PALETTE.subtleText,marginTop: 5,},journalHistory: {marginTop: 20,borderTopWidth: 1,borderTopColor: '#eee',paddingTop: 10,},journalEntry: {backgroundColor: '#f8f9fa',padding: 15,borderRadius: 10,marginBottom: 10,},journalEntryDate: {fontSize: 12,color: '#6c757d',marginBottom: 5,fontWeight: 'bold',},journalEntryText: {fontSize: 14,color: '#343a40',},
  voiceSelector: {flexDirection: 'row',justifyContent: 'center',marginBottom: 20,borderTopWidth: 1,borderBottomWidth: 1,borderColor: '#eee',paddingVertical: 10,},voiceButton: {paddingVertical: 8,paddingHorizontal: 16,borderRadius: 20,backgroundColor: '#f0f4f8',marginHorizontal: 10,},voiceButtonSelected: {backgroundColor: COLOR_PALETTE.accent,shadowColor: '#000',shadowOffset: { width: 0, height: 1 },shadowOpacity: 0.1,shadowRadius: 2,elevation: 2,},voiceButtonText: {color: COLOR_PALETTE.text,fontWeight: '600',},
  formLabel: { fontSize: 16, fontWeight: '500', color: COLOR_PALETTE.subtleText, marginBottom: 10, },
  input: { backgroundColor: COLOR_PALETTE.background, borderRadius: 15, padding: 15, fontSize: 16, color: COLOR_PALETTE.text, marginBottom: 15, borderWidth: 1, borderColor: '#e9ecef' },
  dateContainer: { flexDirection: 'row', justifyContent: 'space-around', backgroundColor: COLOR_PALETTE.background, padding: 15, borderRadius: 15, marginBottom: 20 },
  dateText: { fontSize: 18, color: COLOR_PALETTE.primary, fontWeight: '600' },
});